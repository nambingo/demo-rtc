...
import static com.giahan.app.vietskindoctor.screens.khamonline.KhamOnlineFragment.*;
import static com.giahan.app.vietskindoctor.screens.khamonline.KhamOnlineFragment.TAG_ACCEPT;
import static com.giahan.app.vietskindoctor.screens.khamonline.KhamOnlineFragment.TAG_COMPLETE;
...
public class ListSessionAdapter extends RecyclerView.Adapter<ListSessionAdapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        void binData(Session session) {
            ...
            tvDoctor.setText(TextUtils.isEmpty(session.getDoctorName())
                    ? mContext.getString(
                    R.string.chua_co_bac_si)
                    : String.format("Bs. %s", session.getDoctorName()));
        }
    }
}
