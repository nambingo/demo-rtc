...
public class FragNavController {
    ...
    public FragNavController(Bundle savedInstanceState, @NonNull FragmentManager fragmentManager, @IdRes
            int containerId, @NonNull Fragment rootFragment) {
     ...
     */
    public FragNavController(Bundle savedInstanceState, @NonNull FragmentManager fragmentManager, @IdRes
            int containerId, @NonNull List<Fragment> rootFragments, @TabIndex int startingIndex) {
     ...
     */
    public FragNavController(Bundle savedInstanceState, @NonNull FragmentManager fragmentManager, @IdRes
            int containerId, RootFragmentListener rootFragmentListener, int numberOfTabs, @TabIndex int startingIndex) {
     ...
     */
    private boolean restoreFromBundle(Bundle savedInstanceState, @Nullable
    ...
    @IntDef({TAB_1, TAB_2, TAB_3, TAB_4, TAB_5})
