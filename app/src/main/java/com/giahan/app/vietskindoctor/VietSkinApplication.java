...
public class VietSkinApplication extends Application {
    private static VietSkinApplication INSTANCE;
    ...
    public static VietSkinApplication getInstance() {
        return INSTANCE;
    }
    ...
    public static void setIsShowDialogUpdate(boolean isShowDialogUpdate) {
        VietSkinApplication.isShowDialogUpdate = isShowDialogUpdate;
    }
    ...
    public static void setIsBackToSession(boolean isBackToSession) {
        VietSkinApplication.isBackToSession = isBackToSession;
    }
    ...
    public static void setIsOpenDetailScreen(boolean isOpenDetailScreen) {
        VietSkinApplication.isOpenDetailScreen = isOpenDetailScreen;
    }
}
